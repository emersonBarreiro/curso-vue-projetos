<template>
	<div id="app">
		<!-- na linha abaixo, estamos explicitamente gerando um clone,
		pois arrays são normalmente passados por referência, 
		e ao mexer nele no componente filho, isto pode gerar
		um impacto no componente pai -->
